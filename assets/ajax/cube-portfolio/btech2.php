            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $sql = "SELECT DISTINCT batch_id FROM students_profile WHERE programme_id=2";
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td><a href=viewStudents.php?batch_id='.$row['batch_id'].'&programme_id=2><span class="label label-success">View List</span></a></td>';
                            echo "</tr>";
                            $i++;
                        }
                        mysqli_close($conn);
