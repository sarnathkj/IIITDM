...
<div class="wrapper">
    ...
    <div class="breadcrumbs">
        <div class="container">
            <h1 class="pull-left">Undergraduate Courses</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 md-margin-bottom-30">
                    <h2 class="title-v2" id="UndergraduateAdmissions">Undergraduate Admissions</h2>
                    <p>The Institute is presently offering 4 year B.Tech programs in Computer Engineering, Electronics Engineering (Design & Manufacturing), and Mechanical Engineering (Design and Manufacturing). The B.Tech programmes have attracted high ranking JEE-Main students and have earned appreciation for the design focussed engineering curricula. Our novel design centric B.Tech programme have earned a good reputation among foreign universities as well. Our alumni have secured MS and Direct Ph.D admission in institutes of international repute like Stanford, Georgia Tech, UC Irvine, USC, Pen State, NCSU, Arizona, etc.,</p>
                    
                    <p>B.Tech programmes of the Institute is unique and first of its kind in India which imbibe the principle of “Learning By Doing”. The pedagogical practices followed at IIITDM Kancheepuram employ experiential learning to produce design engineers equipped with good hands on experience in the respective engineering sector.</p>
                    
                    <p>Practice based courses are given more importance and weightage and state-of-the art hardware, software and other facilities are introduced. The Association for Computing Machinery (ACM) based Computer Engineering curriculum offers more electronics engineering courses, and hence will produce engineers with skills required for efficient hardware software interaction and intelligent product design and development.</p>

                    <p>Computer & Electronics Engineering (Design & Manufacturing) graduates of IIITDM will be proficient with design and development of complex electronic systems and subsystems as a result of the exhaustive exposure to emerging areas such as embedded systems, VLSI design, human computer interaction, power electronics, control and instrumentation.</p>
                    
                    <p>Mechanical engineering graduates will be equipped with good hands on skills in sensors, controls, electronics and automation, in addition to the conventional mechanical engineering areas. The laboratories are equipped with state of the art and modern equipments to supplement the experiential learning thrust of the curricula. The curricula involve engineering simulation courses to enhance the visualization skills and our laboratories are equipped with high end workstations and powerful simulation softwares.</p>
                    
                    <p>IIITDM Kancheepuram is an autonomous Institute established in 2007 and fully funded by MHRD, Govt. of India with the mandate of specializing in design and manufacturing oriented engineering education and research. The curricula and other academic/research activities adopt an inter-disciplinary approach with focus on experiential learning and information science based modern tools and techniques. A strong foothold in the design market will propel the nation’s growth and IIITDM’s are a result of the Government of India’s vision to produce next generation engineers capable of designing innovative products.</p>
                    
                    <p>All the faculty at IIITDM Kancheepuram are Doctoral degree holders with a good research background. The Institute has well equipped laboratories and software required for the undergraduate and postgraduate programmes offered.</p><br>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="responsive-video">
                        <iframe src="https://www.youtube.com/embed/0RYfXo1mpks" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12 md-margin-bottom-30" id="LOP">
                    ...
                    <div class="panel panel-green margin-bottom-40">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-tasks"></i> Under Graduate Programmes</h3>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT id,name FROM programme WHERE prog_type=1";
